...
public class VRInputModule : PointerInputModule
{
    ...
    {
        var canvasCheck = obj.GetComponentInParent<VRCanvas>();
    ...
    protected virtual void ClickOnUp(VRUIPointer pointer, List<RaycastResult> results)
    {
    ...
    protected virtual void ClickOnDown(VRUIPointer pointer, List<RaycastResult> results, bool forceClick = false)
    {
    ...
    protected virtual bool IsEligibleClick(VRUIPointer pointer, List<RaycastResult> results)
    {
    ...
    protected virtual void Scroll(VRUIPointer pointer, List<RaycastResult> results)
    {
        ...
        pointer.pointerEventData.scrollDelta = pointer.controller.trackpadAction.GetAxis(pointer.controller.handType);
